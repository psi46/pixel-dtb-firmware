...
MEM_0 := dtb_system_descriptor_memory
...
$(MEM_0)_START := 0x08402000
$(MEM_0)_END := 0x084023ff
...
MEM_2 := ram_ext
$(MEM_2)_NAME := ram_ext
$(MEM_2)_MEM_INIT_FILE_PARAM_NAME := MEM_INIT_FILE
...
$(MEM_2)_HIERARCHICAL_PATH := ram_ext
$(MEM_2)_WIDTH := 64
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: ram_ext
ram_ext: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
