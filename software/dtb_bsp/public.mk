...
# Design Name 
# setting SOPC_NAME is dtb_system
SOPC_NAME := dtb_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8100000
SOPC_SYSID_FLAG += --sidp=0x8100000
ELF_PATCH_FLAG  += --sidp 0x8100000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1465551585
SOPC_SYSID_FLAG += --timestamp=1465551585
ELF_PATCH_FLAG  += --timestamp 1465551585
