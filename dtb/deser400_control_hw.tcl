...
# Mon Nov 30 19:17:13 CET 2015
# DO NOT MODIFY


# 
# deser400_control "deser400_control" v1.0
# Beat Meier 2015.11.30.19:17:13
# deser400 control interface
# 
...
# 
set_module_property DESCRIPTION "deser400 control interface"
set_module_property NAME deser400_control
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP DTB
set_module_property AUTHOR "Beat Meier"
set_module_property DISPLAY_NAME deser400_control
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL deser400_control
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file deser400_control.v VERILOG PATH ip/deser400_control/deser400_control.v TOP_LEVEL_FILE
...
# 
# connection point deser400_io
# 
add_interface deser400_io conduit end
set_interface_property deser400_io associatedClock clock
set_interface_property deser400_io associatedReset clock_reset
set_interface_property deser400_io ENABLED true
set_interface_property deser400_io EXPORT_OF ""
set_interface_property deser400_io PORT_NAME_MAP ""
set_interface_property deser400_io CMSIS_SVD_VARIABLES ""
set_interface_property deser400_io SVD_ADDRESS_GROUP ""

add_interface_port deser400_io write export Output 1
add_interface_port deser400_io read export Output 1
add_interface_port deser400_io address export Output 4
add_interface_port deser400_io writedata export Output 32
add_interface_port deser400_io readdata export Input 32
