...
create_generated_clock -name {inst14|inst23|altpll_component|auto_generated|pll1|clk[2]} -source [get_pins {inst14|inst23|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 1 -divide_by 2 -master_clock {clk50} [get_pins {inst14|inst23|altpll_component|auto_generated|pll1|clk[2]}] 
create_generated_clock -name {inst14|inst23|altpll_component|auto_generated|pll1|clk[3]} -source [get_pins {inst14|inst23|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 1 -divide_by 20 -master_clock {clk50} [get_pins {inst14|inst23|altpll_component|auto_generated|pll1|clk[3]}] 
