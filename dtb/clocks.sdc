...
set_clock_groups \
  ...
  -group { clk50 \
     ...
     inst14|inst5|altpll_component|auto_generated|pll1|clk[2] \
     inst14|inst5|altpll_component|auto_generated|pll1|clk[3] \
   ...
   -group { clk40_ext \
     ...
     inst14|inst5|altpll_component|auto_generated|pll1|clk[2]~1 \
     inst14|inst5|altpll_component|auto_generated|pll1|clk[3]~1 \
   } \
   -group { usb_clk }
